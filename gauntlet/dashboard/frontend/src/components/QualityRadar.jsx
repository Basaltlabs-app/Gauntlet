...
export default function QualityRadar({ result, isJudging }) {
  ...
  if (!models.length) {
    return (
      <div className="glass rounded-xl p-16 text-center min-h-[300px] flex flex-col items-center justify-center">
        <Target size={32} className="text-[var(--text-muted)] mb-4" />
        <p className="text-sm font-medium text-[var(--cs-text)] mb-1.5">No quality data yet</p>
        <p className="text-xs text-[var(--text-dim)] max-w-sm leading-relaxed">
          Quality radar scores (correctness, completeness, clarity, code quality) are generated by the <strong>Compare</strong> feature, not the Benchmark.
        </p>
